# Generated by Django 4.2.6 on 2025-01-21 01:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "shoulder_width",
                    models.FloatField(blank=True, null=True, verbose_name="肩幅 (cm)"),
                ),
                (
                    "chest_width",
                    models.FloatField(blank=True, null=True, verbose_name="胸囲 (cm)"),
                ),
                (
                    "sleeve_length",
                    models.FloatField(blank=True, null=True, verbose_name="袖丈 (cm)"),
                ),
                (
                    "top_length",
                    models.FloatField(blank=True, null=True, verbose_name="着丈 (cm)"),
                ),
                (
                    "waist",
                    models.FloatField(
                        blank=True, null=True, verbose_name="ウエスト (cm)"
                    ),
                ),
                (
                    "hip",
                    models.FloatField(
                        blank=True, null=True, verbose_name="ヒップ (cm)"
                    ),
                ),
                (
                    "rise",
                    models.FloatField(blank=True, null=True, verbose_name="股上 (cm)"),
                ),
                (
                    "inseam",
                    models.FloatField(blank=True, null=True, verbose_name="股下 (cm)"),
                ),
                (
                    "thigh_width",
                    models.FloatField(
                        blank=True, null=True, verbose_name="太もも周り (cm)"
                    ),
                ),
                (
                    "hem_width",
                    models.FloatField(blank=True, null=True, verbose_name="裾幅 (cm)"),
                ),
                (
                    "total_length",
                    models.FloatField(blank=True, null=True, verbose_name="総丈 (cm)"),
                ),
                (
                    "product",
                    models.ForeignKey(
