# Generated by Django 5.1.1 on 2025-01-15 02:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('front_image', models.ImageField(blank=True, null=True, upload_to='products/front/', verbose_name='表画像')),
                ('back_image', models.ImageField(blank=True, null=True, upload_to='products/back/', verbose_name='裏画像')),
                ('admin_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fipleapp.adminuser')),
