                            ...
                            {product.colors.map((color) => (
                                <React.Fragment key={color}>
                                    <tr className="hover:bg-gray-100">
                                        <td className="border-b border-gray-300 p-2" rowSpan={product.sizes.length}>{color}</td>
                                        <td className="border-b border-gray-300 p-2">{product.sizes[0]}</td>
